<template>
    <div id="m_header" >
      ...
      <nav class="m_navigation">
        ...
        <a href="#portofolio" @click.prevent="scrollTo('m_portofolio')" >Portofolio</a>
        <a href="#education" @click.prevent="scrollTo('m_education')" >Education</a>
        <a href="#contact" @click.prevent="scrollTo('m_contact')" >Contact</a>
      </nav>
    </div>
</template>
